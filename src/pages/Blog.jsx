      ...
      <div className="app-container py-20">
        <div className="grid gap-y-15">
            ...
            <div className="group relative overflow-hidden rounded-4xl">
              <img src="images/blog/blog-1.jpg" className="object-cover group-hover:scale-105 transition-transform duration-1000 ease-in-out w-full" alt="About Us" />
            ...
            <div className="grid grid-cols-3 gap-4.5">
                <div className="group">
                    <div className="overflow-hidden rounded-3xl relative mb-3">
                      <img src="images/blog/blog-2.jpg" className="h-65.5 object-cover group-hover:scale-105 transition-transform duration-1000 ease-in-out w-full" alt="About Us" />
                ...
                <div className="group">
                    <div className="overflow-hidden rounded-3xl relative mb-3">
                      <img src="images/blog/blog-3.jpg" className="h-65.5 object-cover group-hover:scale-105 transition-transform duration-1000 ease-in-out w-full" alt="About Us" />
                      <button className="btn absolute bottom-0 translate-y-10 group-hover:-translate-y-5 end-5 bg-gray-200 px-5 group-hover:bg-warning border-0 transition-all duration-500 py-2.5">
                        <i className="icon-right-arrow text-lg group-hover:-rotate-50 transition-all duration-500"></i>
                      </button>
                    </div> 
                ...
                <div className="group">
                    <div className="overflow-hidden rounded-3xl relative mb-3">
                      <img src="images/blog/blog-4.jpg" className="h-65.5 object-cover group-hover:scale-105 transition-transform duration-1000 ease-in-out w-full" alt="About Us" />
                      <button className="btn absolute bottom-0 translate-y-10 group-hover:-translate-y-5 end-5 bg-gray-200 px-5 group-hover:bg-warning border-0 transition-all duration-500 py-2.5">
                        <i className="icon-right-arrow text-lg group-hover:-rotate-50 transition-all duration-500"></i>
                      </button>
                    </div> 
