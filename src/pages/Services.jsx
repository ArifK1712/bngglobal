...
const ServiceLabel = ({ title, className = "", isHeader = false }) => {
  ...
  return (
    <Tag
      className={`relative ps-6 ${isHeader ? "font-medium mb-5 relative z-2" : ""} ${className}`}
    >
...
export default function Services() {
  ...
  useEffect(() => {
    ...
    let ctx = gsap.context(() => {
      ...
      tl.to(standRef.current, { scale: 4 })
        ...
        .to(
          stageRef.current,
          { opacity: 1, zIndex: 50, duration: 0.5 },
          "-=0.3",
        );
      ...
      services.forEach((_, i) => {
        if (i !== 0) {
          ...
          tl.to(
            `.img-layer-${i - 1}`,
            { display: "none", opacity: 0, duration: 0.01 },
            "<",
          );
          tl.to(
            `.img-layer-${i}`,
            { display: "block", opacity: 1, duration: 0.01 },
            "<",
          );
        }
        tl.to({}, { duration: 1.5 });
  ...
  return (
    <div className="bg-white">
      ...
      <h2 className="text-center mt-10 lg:mt-32 mb-0 lg:mb-10">
            ...
            <div className="relative w-full flex items-center justify-between mx-auto">
              ...
              <div className="initial-ui-text space-y-32 ps-20 w-70 flex flex-col items-start">
                ...
                <ServiceLabel
                  title={
                    <>
                      Retail Experiences & <br /> Pop-up venues
                    </>
                  }
                />
              </div>
      ...
      <div className="app-container pt-10 pb-20">
        ...
        <div className="flex gap-3 justify-end pt-5">
          <button
            ...
            className={`btn btn-warning ${startIndex === 0 ? "cursor-not-allowed" : ""}`}
          >
            Prev
          </button>
          ...
          <button
            onClick={nextSlide}
            disabled={startIndex + 5 >= media.length}
            className={`btn btn-warning ${
              startIndex + 5 >= media.length ? "cursor-not-allowed" : ""
            }`}
          >
            Next
          </button>
