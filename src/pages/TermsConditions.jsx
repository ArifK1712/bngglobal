...
const termsData = [
  {
    ...
    content: (
      <>
        <h5 className="text-neutral">Interpretation</h5>
        <p>The words whose initial letters are capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
        <h5 className="text-neutral">Definitions</h5>
        ...
        <ul className="list-disc ps-3">
          ...
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to BNG Arabia Company, BNG Arabia Company, Shara Al Asar, Ishbilyah Dist. Riyadh 13226, Saudi Arabia.</li>
          ...
          <li><strong>Website</strong> refers to BnG Global, accessible from <a href="#" className="underline">https://bngglobal.net/</a></li>
          <li><strong>You</strong> refers to: Saudi Arabia</li>
          <li><strong>Country</strong> refers to: Saudi Arabia</li>
        </ul>
      </>
    )
  ...
  },
  {
    ...
    content: (
      <>
        <h5 className="text-neutral">Severability</h5>
  ...
  },
  {
    ...
    content: (
      <>
      <p>By visiting this page on our website: <a href="javascript:void(0)" className="underline">https://bngglobal.net/contact</a></p>
      </>
    )
  }
];
  ...
  return (
    <>
      <div className="hero relative">
        <img src="/images/hero/terms-conditions.jpg" className="object-cover w-full" alt="Privacy Policy" />
        <h2 className="text-white z-1">Terms and Conditions</h2>      
